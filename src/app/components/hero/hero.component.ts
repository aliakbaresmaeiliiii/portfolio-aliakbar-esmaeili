  ...
  template: `
    <section id="home" class="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse-slow"></div>
      </div>

      <div class="container mx-auto px-6 text-center relative z-10">
        <div class="max-w-4xl mx-auto" [@fadeInStagger]>
          <!-- Profile Image -->
          <div class="w-32 h-32 mx-auto mb-8 rounded-full overflow-hidden border-4 border-blue-500/30 hover:scale-110 transition-transform duration-300 shadow-lg">
            <img 
          ...
          <p class="text-lg text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            Meticulous web developer with over 9 years of front-end experience and a great passion for responsive website design and progressive web applications. Expert in Angular, Node.js, NestJS, and modern JavaScript technologies.
          </p>
