      ...
      <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="text-center mb-16 md:mb-20 animate-fade-in-up">
            <h2
              class="text-4xl md:text-6xl lg:text-7xl font-black mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent"
            >
              Featured Projects
            </h2>
            <p
              class="text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed"
            >
          ...
          >
            ...
            >
              <!-- Project Image -->
              <div
                class="h-48 md:h-64 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden"
              >
                <div
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <span
                    class="text-6xl md:text-8xl text-white opacity-90 drop-shadow-lg"
                    >{{ project.icon }}</span
                  >
                </div>
              ...
              <div class="p-6 md:p-8">
                <h3
                  class="text-xl md:text-2xl font-bold text-slate-800 dark:text-white mb-3 md:mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300"
                >
                  {{ project.title }}
                </h3>
                <p
                  class="text-slate-600 dark:text-slate-300 mb-4 md:mb-6 text-base md:text-lg leading-relaxed"
                >
                  {{ project.description }}
                </p>
                ...
                <div class="flex flex-wrap gap-2 md:gap-3 mb-6 md:mb-8">
                  ...
                  <span
                    class="px-3 py-1 md:px-4 md:py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs md:text-sm font-medium border border-blue-200 dark:border-blue-800 transition-all duration-300 hover:scale-105 hover:bg-blue-200 dark:hover:bg-blue-800/50"
                  >
                    {{ tech }}
                  </span>
                  }
